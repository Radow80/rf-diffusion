...
#     def __init__(self, normalized_shape, eps=1e-9, elementwise_affine=True):
...
class ComplexConv2d(nn.Module):
    def __init__(self, input_channels, num_channels, kernel_size, padding=0, stride=1):
        super().__init__()
...
class ComplexConvTranspose2d(nn.Module):
    def __init__(self, input_channels, num_channels, kernel_size, padding, stride=1):
        super().__init__()
        self.tconv_r = nn.ConvTranspose2d(
            input_channels,
            num_channels,
            kernel_size=kernel_size,
            padding=padding,
        ...
        self.tconv_i = nn.ConvTranspose2d(
            input_channels,
            num_channels,
            kernel_size=kernel_size,
            padding=padding,
    ...
    def forward(self, X):
        return apply_complex(self.tconv_r, self.tconv_i, X)
...
class Complex_normalization(nn.Module):
